...
@Component({
  ...
  template: ` <ul *ngIf="pager.pages && pager.pages.length" class="pagination justify-content-center" style="font-family: var(--sans);">
...
export class ClientPaginationComponent implements OnInit, OnChanges {
  ...
  private paginate(totalItems: number, currentPage: number = 1, pageSize: number = 10, maxPages: number = 10): PagingInfo {
