...
export class RestaurantSysAdminService {
  ...
  public changeRestaurantNameAsync(
    id: string,
    name: string
  ): Observable<boolean> {
    const httpOptions = {
    ...
    return this.http
      .post<boolean>(
        this.baseUrl + '/restaurants/' + encodeURIComponent(id) + '/changename',
        { name },
        httpOptions
      )
      .pipe(take(1));
  ...
  public setRestaurantImportIdAsync(
    id: string,
    importId: string
  ): Observable<boolean> {
    const httpOptions = {
  ...
  public activateRestaurantAsync(id: string): Observable<boolean> {
    ...
    return this.http
      .post<boolean>(
        this.baseUrl + '/restaurants/' + encodeURIComponent(id) + '/activate',
        {},
        httpOptions
      )
      .pipe(take(1));
  ...
  public deactivateRestaurantAsync(id: string): Observable<boolean> {
    ...
    return this.http
      .post<boolean>(
        this.baseUrl + '/restaurants/' + encodeURIComponent(id) + '/deactivate',
        {},
        httpOptions
      )
      .pipe(take(1));
  ...
  public addCuisineToRestaurantAsync(
    id: string,
    cuisineId: string
  ): Observable<boolean> {
    const httpOptions = {
    ...
    return this.http
      .post<boolean>(
        this.baseUrl + '/restaurants/' + encodeURIComponent(id) + '/addcuisine',
        { cuisineId },
        httpOptions
      )
      .pipe(take(1));
  ...
  public removeCuisineFromRestaurantAsync(
    id: string,
    cuisineId: string
  ): Observable<boolean> {
    const httpOptions = {
  ...
  public addAdminToRestaurantAsync(
    id: string,
    userId: string
  ): Observable<boolean> {
    const httpOptions = {
    ...
    return this.http
      .post<boolean>(
        this.baseUrl + '/restaurants/' + encodeURIComponent(id) + '/addadmin',
        { userId },
        httpOptions
      )
      .pipe(take(1));
  ...
  public removeAdminFromRestaurantAsync(
    id: string,
    userId: string
  ): Observable<boolean> {
    const httpOptions = {
  ...
  public enableSupportForRestaurantAsync(
    restaurantId: string
  ): Observable<void> {
    const httpOptions = {
      headers: new HttpHeaders({
  ...
  public disableSupportForRestaurantAsync(
    restaurantId: string
  ): Observable<void> {
    const httpOptions = {
      headers: new HttpHeaders({
  ...
  public removeRestaurantAsync(restaurantId: string): Observable<void> {
    ...
    return this.http
      .delete<void>(this.baseUrl + '/restaurants/' + restaurantId, httpOptions)
      .pipe(take(1));
  }

  public importRestaurantsAsync(
    importFile: File,
    dryRun: boolean
    ...
    return this.http
      .post<ImportLogModel>(url, formData, httpOptions)
      .pipe(take(1));
  }

  public importDishesAsync(
    importFile: File,
    dryRun: boolean
  ): Observable<ImportLogModel> {
    const formData: FormData = new FormData();
