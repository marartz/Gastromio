...
{
    public class DecOrderOfDishCategoryCommandHandler : ICommandHandler<DecOrderOfDishCategoryCommand>
    {
        ...
        public async Task HandleAsync(DecOrderOfDishCategoryCommand command, User currentUser,
